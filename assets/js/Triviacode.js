...
const question= ["What is the name of the process of making Beer?","Humans all over the world consume approximately how much beer in a year?",
...
const answer= ["Brewing","Brewery","50 billion gallons","Zythology","Pilsner","Czech Republic","1st Day of August","Tea","Mead (An alcoholic drink that was discovered mistakenly)","Belgium"]
...
{
  questions: "Humans all over the world consume approximately how much beer in a year?",
  answers: ["337 Million Gallons","8 billion gallons"],
  rightans: ["50 billion gallons"],
},
{
  questions: "The building that is dedicated to making beer is known as what?",
...
{
  questions: "After beer what is the second most consumed drink on the earth (excluding water)?",
